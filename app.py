...
# === STOPWORDS ===
stopwords = {'yang', 'dan', 'untuk', 'dengan', 'juga', 'saya', 'kami', 'ada', 'itu', 'di','ke', 'dari', 'pada', 'atau', 'tidak', 'karena', 'dalam', 'lagi', 'sudah','kalau', 'jadi', 'semua', 'bisa', 'aja', 'akan', 'oleh', 'seperti', 'mau','nih', 'nya', 'cuma', 'hanya', 'the', 'and', 'but', 'was', 'with', 'you', 'are', 'not', 'very','good', 'tempat', 'sangat', 'sekali', 'enak', 'banget', 'bintang', 'mantap', 'baik', 'banyak', 'buat', 'cukup', 'disini', 'tapi', 'kalau', 'pasti', 'untuk', 'dengan', 'saat', 'dapat', 'lagi', 'sudah', 'memang', 'pun', 'juga','selama', 'serta', 'hingga', 'bahwa', 'tanpa', 'tentang'}
...
if uploaded_file:
    ...
    # --- MENAMBAHKAN CHECKBOX UNTUK TABEL ---
